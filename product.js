...
if (!addBtn) console.error("등록 버튼을 찾을 수 없습니다!");
else addBtn.addEventListener("click", async () => {
  console.log("등록 버튼 클릭 확인");
  ...
  try {
    ...
    alert("상품 등록 완료!");
    if (window.showProductListScreen) window.showProductListScreen();
  } catch (e) {
